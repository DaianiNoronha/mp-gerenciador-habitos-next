...
export default function Home() {
  ...
  return (
    <main className="container relative flex flex-col gap-8 px-4 pt-16">
      ...
      Object.entries(habits).map(([habit, habitStreak]) => (
          <div key={habit} className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
              ...
              <button>
                <Image src="/trash.svg" width={20} height={20} alt="Ícone de lixeira vermelha"/>
              </button>
            </div>
            <section className="grid grid-cols-7 bg-neutral-800 rounded-md p-2">
              {sortedWeekDays.map((day) => (
                <div key={day} className="flex flex-col lest:font-bold">
     ...
     <Link href="novo-habito" className="fixed text-center bottom-10 w-2/3 left-1/2 -translate-x-1/2 text-neutral-900 bg-[#45EDAD] font-display font-regular text-2xl p-2">novo hábito</Link>
    </main>
  );
}
